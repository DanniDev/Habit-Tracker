              ...
              <div className="">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block p-2 pl-10 text-sm text-gray-900 border border-gray-400 rounded-lg w-80 bg-white dark:placeholder-gray-400 dark:text-gray-600 "
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-[1px] border-gray-200">
                  <tr>
                    ...
                    <th scope="col" className="px-5 pr-0 py-3 font-bold">
                      Action
                    </th>
                  </tr>
                </thead>
